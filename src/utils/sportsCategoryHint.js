...
function sportKeyFromCategoryName(name) {
  ...
  if (/epl|la liga|serie a|ligue1|bundesliga|champions league|europa league|conference league|international soccer|european soccer|beachsoccer|mls|primeiraportugal|eredivisie|belgianproleague/.test(text)) return 'football'
  ...
  if (/formula1|motogp|nascar|indycar|wrc|automotoracing|motorsport|elc/.test(text)) return 'motorsport'
