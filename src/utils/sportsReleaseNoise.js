const SPORTS_RELEASE_NOISE_PATTERN = String.raw`\b(?:2160p|1080p|1080i|720p|576p|540p|480p)(?:[a-z]{1,6})?(?:\d{2,3}fps)?\b|\b\d{2,3}fps\b|\b(?:x264|x265|h264|h265|hevc|avc|av1|web[\s._-]*dl|web[\s._-]*rip|web|hdtv|repack|proper|complete|aac|ac3|ddp?\d?(?:\.\d)?|multi)\b`
