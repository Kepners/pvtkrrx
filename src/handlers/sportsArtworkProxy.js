...
async function renderTemplateFallbackArtwork(variant, fallbackInput = {}, template = 'ticket-stub', logoFallbackReason = 'template_glyph_fallback', logoContext = {}) {
  ...
  try {
    ...
    const leagueFallbackForCompetitors = ['tennis_or_snooker_match', 'combat_event', 'darts_event'].includes(eventClass)
    const realLogoForSlot = (role = '') => {
      if (role === 'home') return realHomeLogo || (leagueFallbackForCompetitors ? realLeagueLogo : null)
      if (role === 'away') return realAwayLogo || (leagueFallbackForCompetitors ? realLeagueLogo : null)
...
const LEAGUE_SLUG_ALIASES = Object.freeze({
  ...
  'turkish airlines euroleague': 'euroleague-basketball',
  ...
  'pdc': 'pdc-darts',
  'pdc darts': 'pdc-darts',
  'professional darts corporation': 'pdc-darts',
  'world darts championship': 'pdc-darts',
  'premier league darts': 'pdc-darts',
  'tour de france': 'tour-de-france',
  'tdf': 'tour-de-france',
  'tour de france femmes': 'tour-de-france-femmes',
  'tour de france femmes avec zwift': 'tour-de-france-femmes',
  'uci world tour': 'uci-world-tour',
  'uci worldtour': 'uci-world-tour',
  'uci womens world tour': 'uci-womens-world-tour',
  "uci women's world tour": 'uci-womens-world-tour',
  'afl': 'afl',
  'australian football league': 'afl',
  'nrl': 'australian-national-rugby-league',
  'national rugby league': 'australian-national-rugby-league',
  'australian national rugby league': 'australian-national-rugby-league',
  'english rugby league super league': 'english-rugby-league-super-league',
  'super league rugby': 'english-rugby-league-super-league',
  'rugby super league': 'english-rugby-league-super-league',
  'european rugby challenge cup': 'european-rugby-challenge-cup',
  'epcr challenge cup': 'european-rugby-challenge-cup',
  'challenge cup': 'european-rugby-challenge-cup'
})
...
const DEFAULT_LEAGUE_LOGO_RULES = Object.freeze([
  ...
  {
    sport: 'basketball',
    pattern: /\b(?:euro\s*league|euroleague|turkish\s+airlines\s+euroleague)\b/i,
    canonicalIds: ['sportsmeta:league:basketball|euroleague-basketball'],
    searchTerms: ['EuroLeague Basketball'],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/l8hhxs1554397545.png']
  },
  {
    sport: 'basketball',
    pattern: /\b(?:easy\s*credit\s+bbl|easycredit\s+bbl|basketball\s+bundesliga|german\s+bbl)\b/i,
    canonicalIds: [],
    searchTerms: [],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/0hbbhr1612007167.png']
  },
  {
    sport: 'basketball',
  ...
  },
  {
    ...
    searchTerms: ['NFL'],
    directLogoUrls: ['https://a.espncdn.com/i/teamlogos/leagues/500/nfl.png']
  },
  {
    sport: 'motorsport',
    pattern: /\b(?:formula\s*1|formula\s*one|formula1|\bf1\b)\b/i,
    canonicalIds: ['sportsmeta:league:motorsport|formula-1'],
    searchTerms: ['Formula 1'],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/jiqa741556460666.png']
  },
  {
    sport: 'motorsport',
  ...
  },
  {
    ...
    searchTerms: ['UFC'],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/1gp4vo1722604906.png']
  },
  {
    sport: 'boxing',
    pattern: /\b(?:boxing|bkfc|bare\s+knuckle)\b/i,
    canonicalIds: ['sportsmeta:league:fighting|bkfc', 'sportsmeta:league:boxing|boxing'],
    searchTerms: [],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/wbatgb1564344282.png', 'https://r2.thesportsdb.com/images/media/league/logo/xtssst1473774665.png']
  },
  ...
  },
  {
    ...
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/kvmd941551037675.png']
  },
  {
    sport: 'cycling',
    pattern: /\b(?:tour\s+de\s+france\s+femmes|tour\s+france\s+femmes)\b/i,
    canonicalIds: [],
    searchTerms: [],
    directLogoUrls: ['https://upload.wikimedia.org/wikipedia/commons/9/90/Tour_de_France_Femmes_logo.svg']
  },
  {
    sport: 'cycling',
    pattern: /\b(?:tour\s+de\s+france|tdf|tour\s+france)\b/i,
    canonicalIds: [],
    searchTerms: [],
    directLogoUrls: ['https://upload.wikimedia.org/wikipedia/commons/e/eb/Tour_de_France_logo.svg']
  },
  {
    sport: 'cycling',
    pattern: /\b(?:uci\s+world\s*tour|cycling)\b/i,
    canonicalIds: ['sportsmeta:league:cycling|uci-world-tour'],
    searchTerms: ['UCI World Tour'],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/7fhxtz1555353394.png']
  },
  {
    sport: 'golf',
  ...
  {
    sport: 'rugby',
    pattern: /\b(?:challenge\s+cup|epcr\s+challenge\s+cup|european\s+rugby\s+challenge\s+cup)\b/i,
    canonicalIds: [],
    searchTerms: [],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/dwmh511716589311.png']
  },
  {
    sport: 'rugby',
    pattern: /\b(?:english\s+rugby\s+league\s+super\s+league|super\s+league\s+rugby|rugby\s+super\s+league)\b/i,
    canonicalIds: [],
    searchTerms: [],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/3389z61641840924.png']
  },
  {
    sport: 'darts',
    pattern: /\b(?:pdc|darts?|world\s+darts\s+championship|us\s+darts\s+masters|poland\s+darts\s+masters|world\s+cup\s+darts)\b/i,
    canonicalIds: ['sportsmeta:league:darts|pdc-darts'],
    searchTerms: ['PDC Darts'],
    directLogoUrls: ['https://r2.thesportsdb.com/images/media/league/logo/mnkcyf1555604592.png']
  },
  {
    sport: 'badminton',
...
const DIRECT_LEAGUE_LOGO_OVERRIDES = Object.freeze([
  // --- LOGO COVERAGE PASS 2026-05-31 ---
  // --- BASKETBALL (new gap leagues) ---
  { sport: 'basketball', league: 'Italian Lega Basket', pattern: /\b(?:lega\s*basket|legabasket|italian\s+(?:lega\s+basket|serie\s+a\s+basket)|lba|virtus\s+bologna|reyer\s+venezia|olimpia\s+milano)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/zenfi61667129026.png'] },
  { sport: 'basketball', league: 'French LNB Betclic Elite', pattern: /\b(?:betclic\s+elite|lnb\s+pro\s*a|french\s+lnb|pro\s*a\s+basket|paris\s+basketball|sig\s+strasbourg)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/60detm1757608684.png'] },
  { sport: 'basketball', league: 'Turkish Basketbol Super Ligi', pattern: /\b(?:turkish\s+(?:basketbol\s+)?super\s+lig(?:i)?|bsl|tbsl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/bnkkgh1551517800.png'] },
  // --- SOCCER (new gap leagues) ---
  { sport: 'football', league: 'Spanish La Liga 2', pattern: /\b(?:spanish\s+la\s+liga\s*2|laliga\s*2|la\s*liga\s*2|segunda\s+division|segunda\s+divisiÃ³n|laliga\s+hypermotion)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/r7u6821688425700.png'] },
  { sport: 'football', league: 'Canadian Premier League', pattern: /\b(?:canadian\s+premier\s+league|cpl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/oxb08k1769615518.png'] },
  { sport: 'football', league: 'Mexican Liga MX', pattern: /\b(?:liga\s*mx|mexican\s+(?:primera|liga\s*mx)|liga\s+bbva\s+mx)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/mav5rx1686157960.png'] },
  // --- CRICKET (new gap leagues; repo only had IPL) ---
  { sport: 'cricket', league: 'International Cricket (ICC)', pattern: /\b(?:icc|international\s+cricket|cricket\s+world\s+cup|t20\s+world\s+cup|world\s+test\s+championship|wtc|odi|one[-\s]?day\s+international|t20i|test\s+match|tour\s+of|bilateral|tri[-\s]?series|champions\s+trophy|asia\s+cup)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/en/thumb/d/d9/International_Cricket_Council_%28logo%29.svg/960px-International_Cricket_Council_%28logo%29.svg.png'] },
  { sport: 'cricket', league: 'Big Bash League', pattern: /\b(?:big\s+bash(?:\s+league)?|bbl|australian\s+big\s+bash)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/yko7ny1546635346.png'] },
  { sport: 'cricket', league: 'Caribbean Premier League', pattern: /\b(?:caribbean\s+premier\s+league|cpl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/5mjjnj1645179844.png'] },
  { sport: 'cricket', league: 'Bangladesh Premier League', pattern: /\b(?:bangladesh\s+premier\s+league|bpl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/o1xh521767355615.png'] },
  { sport: 'cricket', league: 'The Hundred', pattern: /\bthe\s+hundred\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/abbrjk1754387948.png'] },
  { sport: 'cricket', league: 'SA20', pattern: /\bsa20\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/aakvuk1734183412.png'] },
  { sport: 'cricket', league: 'Lanka Premier League', pattern: /\b(?:lanka\s+premier\s+league|lpl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/qqhube1720698337.png'] },
  { sport: 'cricket', league: 'New Zealand Super Smash', pattern: /\b(?:super\s+smash|new\s+zealand\s+super\s+smash)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/3d5cld1645179187.png'] },
  { sport: 'cricket', league: 'English t20 Blast', pattern: /\b(?:t20\s+blast|vitality\s+blast|english\s+t20\s+blast)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/m1lsns1649766933.png'] },
  { sport: 'cricket', league: 'English County Championship', pattern: /\b(?:county\s+championship|english\s+county\s+championship)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/wei2ri1775588638.png'] },
  { sport: 'cricket', league: 'Sheffield Shield', pattern: /\bsheffield\s+shield\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/cd4akv1742154549.png'] },
  { sport: 'cricket', league: 'Global Super League', pattern: /\bglobal\s+super\s+league\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/e34ujo1742154629.png'] },
  { sport: 'cricket', league: 'Nepal Premier League', pattern: /\bnepal\s+premier\s+league\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/8b0ary1734168233.png'] },
  // --- CYCLING (new gap leagues; PLACE ABOVE the line-1719 'UCI World Tour' catch-all) ---
  { sport: 'cycling', league: "Giro d'Italia", pattern: /\b(?:giro\s+d['â€™]?\s*italia|giro\s+ditalia|giro\s+italia|il\s+giro)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/commons/b/b3/Giro_d%27Italia_-_Logo_2018.svg'] },
  { sport: 'cycling', league: 'Vuelta a Espana', pattern: /\b(?:vuelta\s+a\s+espa(?:n|Ã±)a|la\s+vuelta|vuelta\s+espana)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/commons/4/4b/La_Vuelta_%28Spain%29_logo.svg'] },
  { sport: 'cycling', league: 'Tour of Flanders', pattern: /\b(?:tour\s+of\s+flanders|ronde\s+van\s+vlaanderen|de\s+ronde|rvv)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/commons/9/9c/RVV_LOGO_ENG.svg'] },
  // --- MMA (new promotion leagues; repo only had UFC/BKFC/LFA) ---
  { sport: 'mma', league: 'ONE Championship', pattern: /\b(?:one\s+championship|one\s+fc|one\s+fight\s+night|one\s+friday\s+fights)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/fw81iq1545508019.png'] },
  { sport: 'mma', league: 'ACA', pattern: /\b(?:aca\s*mma|absolute\s+championship\s+akhmat)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/bzmy7c1684321551.png'] },
  { sport: 'mma', league: 'Oktagon MMA', pattern: /\b(?:oktagon\s*mma|oktagon)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/ij6j7x1759141206.png'] },
  { sport: 'mma', league: 'TKO MMA', pattern: /\b(?:tko\s+major\s+league\s+mma|tko\s*mma)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/epgct01669192089.png'] },
  { sport: 'mma', league: 'UAE Warriors', pattern: /\buae\s+warriors\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/gucf3a1760167760.png'] },
  { sport: 'mma', league: 'Jungle Fight', pattern: /\b(?:jungle\s+fight|jungle\s+fc)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/x9cxmq1578222615.png'] },
  ...
  { sport: 'basketball', league: 'NBA', pattern: /\b(?:nba|nba\s+playoffs?)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/ypuryw1421971236.png'] },
  { sport: 'basketball', league: 'EuroLeague Basketball', pattern: /\b(?:euro\s*league|euroleague|turkish\s+airlines\s+euroleague)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/l8hhxs1554397545.png'] },
  { sport: 'basketball', league: 'EasyCredit BBL', pattern: /\b(?:easy\s*credit\s+bbl|easycredit\s+bbl|basketball\s+bundesliga|german\s+bbl)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/0hbbhr1612007167.png'] },
  ...
  { sport: 'american-football', league: 'NFL', pattern: /\bnfl\b/i, urls: ['https://a.espncdn.com/i/teamlogos/leagues/500/nfl.png'] },
  { sport: 'mma', league: 'UFC', pattern: /\bufc\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/bewnz31717531281.png'] },
  { sport: 'mma', league: 'LFA', pattern: /\b(?:lfa|legacy\s+fighting\s+alliance)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/h4u36g1707315238.png'] },
  { sport: 'fighting', league: 'LFA', pattern: /\b(?:lfa|legacy\s+fighting\s+alliance)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/h4u36g1707315238.png'] },
  { sport: 'boxing', league: 'BKFC', pattern: /\b(?:bkfc|bare\s+knuckle)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/wbatgb1564344282.png'] },
  ...
  { sport: 'cycling', league: 'Tour de France Femmes', pattern: /\b(?:tour\s+de\s+france\s+femmes|tour\s+france\s+femmes)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/commons/9/90/Tour_de_France_Femmes_logo.svg'] },
  { sport: 'cycling', league: 'Tour de France', pattern: /\b(?:tour\s+de\s+france|tdf|tour\s+france)\b/i, urls: ['https://upload.wikimedia.org/wikipedia/commons/e/eb/Tour_de_France_logo.svg'] },
  { sport: 'cycling', league: 'UCI World Tour', pattern: /\b(?:uci\s+world\s*tour|cycling)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/7fhxtz1555353394.png'] },
  ...
  { sport: 'rugby', league: 'NRL', pattern: /\b(?:nrl|national\s+rugby\s+league|midweek\s+tackle)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/xryyuy1422583450.png'] },
  { sport: 'rugby', league: 'European Rugby Challenge Cup', pattern: /\b(?:challenge\s+cup|epcr\s+challenge\s+cup|european\s+rugby\s+challenge\s+cup)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/dwmh511716589311.png'] },
  { sport: 'rugby', league: 'English Rugby League Super League', pattern: /\b(?:english\s+rugby\s+league\s+super\s+league|super\s+league\s+rugby|rugby\s+super\s+league)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/3389z61641840924.png'] },
  { sport: 'darts', league: 'PDC Darts', pattern: /\b(?:pdc|darts?|world\s+darts\s+championship|us\s+darts\s+masters|poland\s+darts\s+masters|world\s+cup\s+darts)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/logo/mnkcyf1555604592.png'] },
  { sport: 'basketball', league: 'AFL', pattern: /\b(?:afl|aussie\s+rules|australian\s+football|australian\s+rules\s+football)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/wvx4721525519372.png'] },
  { sport: 'australian-football', league: 'AFL', pattern: /\b(?:afl|aussie\s+rules|australian\s+football|australian\s+rules\s+football)\b/i, urls: ['https://r2.thesportsdb.com/images/media/league/badge/wvx4721525519372.png'] },
...
const DIRECT_TEAM_LOGO_OVERRIDES = Object.freeze([
  ...[
    // --- LOGO COVERAGE PASS 2026-05-31 ---
    // === BASKETBALL â€” Italian Lega Basket ===
    ['basketball', 'Italian Lega Basket', 'Olimpia Milano', ['olimpia milano', 'ea7 emporio armani', 'armani milano'], 'https://r2.thesportsdb.com/images/media/team/badge/m37m9t1767366736.png'],
    ['basketball', 'Italian Lega Basket', 'Derthona Basket', ['derthona basket', 'derthona', 'tortona'], 'https://r2.thesportsdb.com/images/media/team/badge/e0ggtk1722730060.png'],
    ['basketball', 'Italian Lega Basket', 'Dinamo Sassari', ['dinamo basket sassari', 'dinamo sassari', 'sassari'], 'https://r2.thesportsdb.com/images/media/team/badge/c3lell1677428636.png'],
    ['basketball', 'Italian Lega Basket', 'Vanoli Cremona', ['guerino vanoli basket', 'vanoli basket', 'vanoli cremona', 'cremona'], 'https://r2.thesportsdb.com/images/media/team/badge/rizjdk1696583874.png'],
    ['basketball', 'Italian Lega Basket', 'Napoli Basket', ['napoli basket', 'gevi napoli'], 'https://r2.thesportsdb.com/images/media/team/badge/pcauc11755533758.png'],
    ['basketball', 'Italian Lega Basket', 'Germani Brescia', ['pallacanestro brescia', 'germani brescia', 'brescia'], 'https://r2.thesportsdb.com/images/media/team/badge/4flwfa1678899118.png'],
    ['basketball', 'Italian Lega Basket', 'Pallacanestro Cantu', ['pallacanestro cantu', 'pallacanestro cantÃ¹', 'acqua san bernardo cantu', 'cantu'], 'https://r2.thesportsdb.com/images/media/team/badge/xuyuvw1425815459.png'],
    ['basketball', 'Italian Lega Basket', 'Pallacanestro Reggiana', ['pallacanestro reggiana', 'unahotels reggio emilia', 'reggiana', 'reggio emilia'], 'https://r2.thesportsdb.com/images/media/team/badge/6wmh381696582414.png'],
    ['basketball', 'Italian Lega Basket', 'Trapani Shark', ['pallacanestro trapani', 'trapani shark', 'trapani'], 'https://r2.thesportsdb.com/images/media/team/badge/seep4u1719922074.png'],
    ['basketball', 'Italian Lega Basket', 'Pallacanestro Trieste', ['pallacanestro trieste', 'pallacanestro trieste 2004', 'trieste'], 'https://r2.thesportsdb.com/images/media/team/badge/f2d8e01722170707.png'],
    // === BASKETBALL â€” French LNB ===
    ['basketball', 'French LNB', 'AS Monaco Basket', ['as monaco basket', 'monaco basket'], 'https://r2.thesportsdb.com/images/media/team/badge/fl2ti01649168915.png'],
    ['basketball', 'French LNB', 'Boulazac Basket', ['boulazac basket dordogne', 'boulazac', 'dordogne'], 'https://r2.thesportsdb.com/images/media/team/badge/68tu9p1570976593.png'],
    ['basketball', 'French LNB', 'JL Bourg', ['bourg-en-bresse', 'jl bourg', 'bourg basket'], 'https://r2.thesportsdb.com/images/media/team/badge/643qz71523101349.png'],
    ['basketball', 'French LNB', 'Cholet Basket', ['cholet basket', 'cholet'], 'https://r2.thesportsdb.com/images/media/team/badge/rjb2631570976454.png'],
    ['basketball', 'French LNB', 'JDA Dijon', ['jda dijon', 'dijon basket', 'dijon'], 'https://r2.thesportsdb.com/images/media/team/badge/06b1fd1666897191.png'],
    ['basketball', 'French LNB', 'Elan Chalon', ['elan chalon', 'Ã©lan chalon', 'chalon-sur-saone', 'chalon'], 'https://r2.thesportsdb.com/images/media/team/badge/f7jcdk1542825634.png'],
    ['basketball', 'French LNB', 'ESSM Le Portel', ['essm le portel', 'le portel', 'portel'], 'https://r2.thesportsdb.com/images/media/team/badge/yhwnwu1649168935.png'],
    ['basketball', 'French LNB', 'Gravelines-Dunkerque', ['gravelines-dunkerque', 'bcm gravelines', 'gravelines', 'dunkerque'], 'https://r2.thesportsdb.com/images/media/team/badge/1mft2j1757606561.png'],
    ['basketball', 'French LNB', 'Le Mans Sarthe Basket', ['le mans sarthe basket', 'le mans', 'sarthe'], 'https://r2.thesportsdb.com/images/media/team/badge/iouj5l1757607112.png'],
    ['basketball', 'French LNB', 'Limoges CSP', ['limoges csp', 'limoges'], 'https://r2.thesportsdb.com/images/media/team/badge/rryxux1423605495.png'],
    // === BASKETBALL â€” Turkish Basketbol Super Ligi ===
    ['basketball', 'Turkish Basketbol Super Ligi', 'Anadolu Efes', ['anadolu efes sk', 'anadolu efes', 'efes'], 'https://r2.thesportsdb.com/images/media/team/badge/ly2g231758537717.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Bahcesehir Koleji', ['bahcesehir koleji', 'bahcesehir', 'bahÃ§eÅŸehir koleji'], 'https://r2.thesportsdb.com/images/media/team/badge/twgvxv1726910272.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Besiktas Basketbol', ['besiktas basketbol', 'besiktas', 'beÅŸiktaÅŸ'], 'https://r2.thesportsdb.com/images/media/team/badge/rx0o811667119583.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Bursaspor Basketbol', ['bursaspor basketbol', 'bursaspor'], 'https://r2.thesportsdb.com/images/media/team/badge/mwt5rk1678898996.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Buyukcekmece Basketbol', ['buyukcekmece basketbol', 'buyukcekmece', 'bÃ¼yÃ¼kÃ§ekmece'], 'https://r2.thesportsdb.com/images/media/team/badge/t2tekl1521143144.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Esenler Erokspor', ['esenler erokspor', 'erokspor', 'esenler'], 'https://r2.thesportsdb.com/images/media/team/badge/cddejp1758793966.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Fenerbahce Basketbol', ['fenerbahce basketbol', 'fenerbahce beko', 'fenerbahÃ§e basketbol'], 'https://r2.thesportsdb.com/images/media/team/badge/u6j0qb1758794065.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Galatasaray Basketbol', ['galatasaray sk basketbol', 'galatasaray basketbol', 'galatasaray'], 'https://r2.thesportsdb.com/images/media/team/badge/s0648j1688557537.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Pinar Karsiyaka', ['karsiyaka basket', 'pinar karsiyaka', 'karÅŸÄ±yaka', 'karsiyaka'], 'https://r2.thesportsdb.com/images/media/team/badge/mhh1y41739692642.png'],
    ['basketball', 'Turkish Basketbol Super Ligi', 'Manisa BBSK', ['manisa bb', 'manisa basket', 'manisa buyuksehir', 'manisa'], 'https://r2.thesportsdb.com/images/media/team/badge/dee2ms1740771670.png'],
    // === BASKETBALL â€” German BBL ===
    ['basketball', 'German BBL', 'ALBA Berlin', ['alba berlin'], 'https://r2.thesportsdb.com/images/media/team/badge/58osvu1545866407.png'],
    ['basketball', 'German BBL', 'Bamberg Baskets', ['bamberg baskets', 'brose bamberg', 'bamberg'], 'https://r2.thesportsdb.com/images/media/team/badge/rs1gjz1714562746.png'],
    ['basketball', 'German BBL', 'EWE Baskets Oldenburg', ['baskets oldenburg', 'ewe baskets', 'oldenburg'], 'https://r2.thesportsdb.com/images/media/team/badge/ryf75v1545866721.png'],
    ['basketball', 'German BBL', 'Bayern Munich Basketball', ['bayern munchen basketball', 'fc bayern basketball', 'bayern munich basketball', 'bayern munchen', 'bayern mÃ¼nchen'], 'https://r2.thesportsdb.com/images/media/team/badge/z2r3eh1678017187.png'],
    ['basketball', 'German BBL', 'Telekom Baskets Bonn', ['telekom baskets bonn', 'baskets bonn', 'bonn'], 'https://r2.thesportsdb.com/images/media/team/badge/fva1jj1726927533.png'],
    ['basketball', 'German BBL', 'Basketball Lowen Braunschweig', ['basketball lowen braunschweig', 'loewen braunschweig', 'braunschweig'], 'https://r2.thesportsdb.com/images/media/team/badge/uwo9uy1629447507.png'],
    ['basketball', 'German BBL', 'Gladiators Trier', ['gladiators trier', 'romerstrom gladiators', 'trier'], 'https://r2.thesportsdb.com/images/media/team/badge/fb8dgi1726928363.png'],
    ['basketball', 'German BBL', 'Veolia Towers Hamburg', ['hamburg towers', 'veolia towers hamburg', 'towers hamburg', 'hamburg'], 'https://r2.thesportsdb.com/images/media/team/badge/8lgw7d1677762511.png'],
    ['basketball', 'German BBL', 'MHP Riesen Ludwigsburg', ['mhp riesen ludwigsburg', 'riesen ludwigsburg', 'ludwigsburg'], 'https://r2.thesportsdb.com/images/media/team/badge/6guil91488108871.png'],
    ['basketball', 'German BBL', 'Mitteldeutscher BC', ['mitteldeutscher bc', 'weissenfels'], 'https://r2.thesportsdb.com/images/media/team/badge/y4h9ox1714562760.png'],
    // === SOCCER â€” Spanish La Liga 2 (ESPN badges) ===
    ['football', 'Spanish La Liga 2', 'Cultural Leonesa', ['cultural leonesa', 'leonesa'], 'https://a.espncdn.com/i/teamlogos/soccer/500/10629.png'],
    ['football', 'Spanish La Liga 2', 'Real Sociedad B', ['real sociedad b', 'real sociedad ii', 'sociedad b'], 'https://a.espncdn.com/i/teamlogos/soccer/500/20983.png'],
    ['football', 'Spanish La Liga 2', 'Albacete', ['albacete'], 'https://a.espncdn.com/i/teamlogos/soccer/500/2737.png'],
    ['football', 'Spanish La Liga 2', 'Almeria', ['almeria', 'almerÃ­a'], 'https://a.espncdn.com/i/teamlogos/soccer/500/6832.png'],
    ['football', 'Spanish La Liga 2', 'Burgos', ['burgos'], 'https://a.espncdn.com/i/teamlogos/soccer/500/12597.png'],
    ['football', 'Spanish La Liga 2', 'Castellon', ['castellon', 'castellÃ³n'], 'https://a.espncdn.com/i/teamlogos/soccer/500/4438.png'],
    ['football', 'Spanish La Liga 2', 'AD Ceuta', ['ad ceuta', 'ceuta'], 'https://a.espncdn.com/i/teamlogos/soccer/500/5404.png'],
    ['football', 'Spanish La Liga 2', 'Cadiz', ['cadiz', 'cÃ¡diz'], 'https://a.espncdn.com/i/teamlogos/soccer/500/3842.png'],
    ['football', 'Spanish La Liga 2', 'Cordoba', ['cordoba', 'cÃ³rdoba'], 'https://a.espncdn.com/i/teamlogos/soccer/500/8447.png'],
    ['football', 'Spanish La Liga 2', 'Deportivo La Coruna', ['deportivo la coruna', 'deportivo', 'la coruna', 'depor'], 'https://a.espncdn.com/i/teamlogos/soccer/500/90.png'],
    ['football', 'Spanish La Liga 2', 'Eibar', ['eibar'], 'https://a.espncdn.com/i/teamlogos/soccer/500/3752.png'],
    ['football', 'Spanish La Liga 2', 'FC Andorra', ['fc andorra', 'andorra'], 'https://a.espncdn.com/i/teamlogos/soccer/500/20179.png'],
    ['football', 'Spanish La Liga 2', 'Granada', ['granada'], 'https://a.espncdn.com/i/teamlogos/soccer/500/3747.png'],
    ['football', 'Spanish La Liga 2', 'Huesca', ['huesca'], 'https://a.espncdn.com/i/teamlogos/soccer/500/5413.png'],
    ['football', 'Spanish La Liga 2', 'Las Palmas', ['las palmas'], 'https://a.espncdn.com/i/teamlogos/soccer/500/98.png'],
    ['football', 'Spanish La Liga 2', 'Leganes', ['leganes', 'leganÃ©s'], 'https://a.espncdn.com/i/teamlogos/soccer/500/17534.png'],
    ['football', 'Spanish La Liga 2', 'Mirandes', ['mirandes', 'mirandÃ©s'], 'https://a.espncdn.com/i/teamlogos/soccer/500/4515.png'],
    ['football', 'Spanish La Liga 2', 'Malaga', ['malaga', 'mÃ¡laga'], 'https://a.espncdn.com/i/teamlogos/soccer/500/99.png'],
    ['football', 'Spanish La Liga 2', 'Racing Santander', ['racing santander', 'racing de santander'], 'https://a.espncdn.com/i/teamlogos/soccer/500/87.png'],
    ['football', 'Spanish La Liga 2', 'Real Valladolid', ['real valladolid', 'valladolid'], 'https://a.espncdn.com/i/teamlogos/soccer/500/95.png'],
    ['football', 'Spanish La Liga 2', 'Real Zaragoza', ['real zaragoza', 'zaragoza'], 'https://a.espncdn.com/i/teamlogos/soccer/500/91.png'],
    ['football', 'Spanish La Liga 2', 'Sporting Gijon', ['sporting gijon', 'gijon', 'sporting gijÃ³n'], 'https://a.espncdn.com/i/teamlogos/soccer/500/3788.png'],
    // === SOCCER â€” Mexican Liga MX (ESPN badges) ===
    ['football', 'Mexican Liga MX', 'Toluca', ['deportivo toluca', 'toluca'], 'https://a.espncdn.com/i/teamlogos/soccer/500/223.png'],
    ['football', 'Mexican Liga MX', 'Club America', ['club america', 'amÃ©rica'], 'https://a.espncdn.com/i/teamlogos/soccer/500/227.png'],
    ['football', 'Mexican Liga MX', 'Atlas', ['atlas'], 'https://a.espncdn.com/i/teamlogos/soccer/500/216.png'],
    ['football', 'Mexican Liga MX', 'Atletico San Luis', ['atletico san luis', 'san luis', 'atlÃ©tico de san luis'], 'https://a.espncdn.com/i/teamlogos/soccer/500/15720.png'],
    ['football', 'Mexican Liga MX', 'Cruz Azul', ['cruz azul'], 'https://a.espncdn.com/i/teamlogos/soccer/500/218.png'],
    ['football', 'Mexican Liga MX', 'FC Juarez', ['fc juarez', 'juarez', 'juÃ¡rez'], 'https://a.espncdn.com/i/teamlogos/soccer/500/17851.png'],
    ['football', 'Mexican Liga MX', 'Guadalajara', ['guadalajara', 'chivas'], 'https://a.espncdn.com/i/teamlogos/soccer/500/219.png'],
    ['football', 'Mexican Liga MX', 'Club Leon', ['club leon', 'leon', 'leÃ³n'], 'https://a.espncdn.com/i/teamlogos/soccer/500/228.png'],
    ['football', 'Mexican Liga MX', 'Mazatlan FC', ['mazatlan fc', 'mazatlan', 'mazatlÃ¡n'], 'https://a.espncdn.com/i/teamlogos/soccer/500/20702.png'],
    ['football', 'Mexican Liga MX', 'Monterrey', ['monterrey', 'rayados'], 'https://a.espncdn.com/i/teamlogos/soccer/500/220.png'],
    ['football', 'Mexican Liga MX', 'Necaxa', ['necaxa'], 'https://a.espncdn.com/i/teamlogos/soccer/500/229.png'],
    ['football', 'Mexican Liga MX', 'Pachuca', ['pachuca'], 'https://a.espncdn.com/i/teamlogos/soccer/500/234.png'],
    ['football', 'Mexican Liga MX', 'Puebla', ['puebla'], 'https://a.espncdn.com/i/teamlogos/soccer/500/231.png'],
    ['football', 'Mexican Liga MX', 'Pumas UNAM', ['pumas unam', 'pumas', 'unam'], 'https://a.espncdn.com/i/teamlogos/soccer/500/233.png'],
    ['football', 'Mexican Liga MX', 'Queretaro', ['queretaro', 'querÃ©taro', 'gallos blancos'], 'https://a.espncdn.com/i/teamlogos/soccer/500/222.png'],
    ['football', 'Mexican Liga MX', 'Santos Laguna', ['santos laguna'], 'https://a.espncdn.com/i/teamlogos/soccer/500/225.png'],
    ['football', 'Mexican Liga MX', 'Tigres UANL', ['tigres uanl', 'tigres', 'uanl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/232.png'],
    ['football', 'Mexican Liga MX', 'Club Tijuana', ['club tijuana', 'tijuana', 'xolos'], 'https://a.espncdn.com/i/teamlogos/soccer/500/10125.png'],
    // === SOCCER â€” Canadian Premier League (TheSportsDB badges) ===
    ['football', 'Canadian Premier League', 'Pacific FC', ['pacific fc'], 'https://r2.thesportsdb.com/images/media/team/badge/6qzhpj1583351283.png'],
    ['football', 'Canadian Premier League', 'Atletico Ottawa', ['atletico ottawa', 'atlÃ©tico ottawa'], 'https://r2.thesportsdb.com/images/media/team/badge/k5gzuw1583351260.png'],
    ['football', 'Canadian Premier League', 'Forge FC', ['forge fc'], 'https://r2.thesportsdb.com/images/media/team/badge/48dk0h1582572865.png'],
    ['football', 'Canadian Premier League', 'Cavalry FC', ['cavalry fc', 'cavalry'], 'https://r2.thesportsdb.com/images/media/team/badge/gpi5qj1583351269.png'],
    ['football', 'Canadian Premier League', 'HFX Wanderers', ['hfx wanderers', 'halifax wanderers'], 'https://r2.thesportsdb.com/images/media/team/badge/uqkf0n1583351277.png'],
    ['football', 'Canadian Premier League', 'York United', ['york united', 'york9'], 'https://r2.thesportsdb.com/images/media/team/badge/rwzvfv1609089907.png'],
    // === SOCCER â€” National teams (ESPN country flags) ===
    ['football', '', 'Czech Republic', ['czech republic', 'czechia'], 'https://a.espncdn.com/i/teamlogos/countries/500/cze.png'],
    ['football', '', 'Kosovo', ['kosovo'], 'https://a.espncdn.com/i/teamlogos/countries/500/kosovo.png'],
    ['football', '', 'Spain', ['spain'], 'https://a.espncdn.com/i/teamlogos/countries/500/esp.png'],
    ['football', '', 'Germany', ['germany'], 'https://a.espncdn.com/i/teamlogos/countries/500/ger.png'],
    ['football', '', 'France', ['france'], 'https://a.espncdn.com/i/teamlogos/countries/500/fra.png'],
    ['football', '', 'Italy', ['italy'], 'https://a.espncdn.com/i/teamlogos/countries/500/ita.png'],
    ['football', '', 'England', ['england'], 'https://a.espncdn.com/i/teamlogos/countries/500/eng.png'],
    ['football', '', 'Portugal', ['portugal'], 'https://a.espncdn.com/i/teamlogos/countries/500/por.png'],
    ['football', '', 'Brazil', ['brazil'], 'https://a.espncdn.com/i/teamlogos/countries/500/bra.png'],
    ['football', '', 'Argentina', ['argentina'], 'https://a.espncdn.com/i/teamlogos/countries/500/arg.png'],
    ['football', '', 'Netherlands', ['netherlands', 'holland'], 'https://a.espncdn.com/i/teamlogos/countries/500/ned.png'],
    ['football', '', 'Belgium', ['belgium'], 'https://a.espncdn.com/i/teamlogos/countries/500/bel.png'],
    ['football', '', 'Croatia', ['croatia'], 'https://a.espncdn.com/i/teamlogos/countries/500/cro.png'],
    ['football', '', 'Poland', ['poland'], 'https://a.espncdn.com/i/teamlogos/countries/500/pol.png'],
    ['football', '', 'Sweden', ['sweden'], 'https://a.espncdn.com/i/teamlogos/countries/500/swe.png'],
    ['football', '', 'Norway', ['norway'], 'https://a.espncdn.com/i/teamlogos/countries/500/nor.png'],
    ['football', '', 'Denmark', ['denmark'], 'https://a.espncdn.com/i/teamlogos/countries/500/den.png'],
    ['football', '', 'Austria', ['austria'], 'https://a.espncdn.com/i/teamlogos/countries/500/aut.png'],
    ['football', '', 'Switzerland', ['switzerland'], 'https://a.espncdn.com/i/teamlogos/countries/500/sui.png'],
    ['football', '', 'Wales', ['wales'], 'https://a.espncdn.com/i/teamlogos/countries/500/wal.png'],
    ['football', '', 'Scotland', ['scotland'], 'https://a.espncdn.com/i/teamlogos/countries/500/sco.png'],
    ['football', '', 'Republic of Ireland', ['republic of ireland', 'ireland'], 'https://a.espncdn.com/i/teamlogos/countries/500/irl.png'],
    ['football', '', 'Northern Ireland', ['northern ireland'], 'https://a.espncdn.com/i/teamlogos/countries/500/nir.png'],
    ['football', '', 'Serbia', ['serbia'], 'https://a.espncdn.com/i/teamlogos/countries/500/sba.png'],
    ['football', '', 'Greece', ['greece'], 'https://a.espncdn.com/i/teamlogos/countries/500/gre.png'],
    ['football', '', 'Romania', ['romania'], 'https://a.espncdn.com/i/teamlogos/countries/500/rom.png'],
    ['football', '', 'Hungary', ['hungary'], 'https://a.espncdn.com/i/teamlogos/countries/500/hun.png'],
    ['football', '', 'Ukraine', ['ukraine'], 'https://a.espncdn.com/i/teamlogos/countries/500/ukr.png'],
    ['football', '', 'Turkey', ['turkey', 'turkiye', 'tÃ¼rkiye'], 'https://a.espncdn.com/i/teamlogos/countries/500/tur.png'],
    ['football', '', 'Iceland', ['iceland'], 'https://a.espncdn.com/i/teamlogos/countries/500/isl.png'],
    ['football', '', 'Finland', ['finland'], 'https://a.espncdn.com/i/teamlogos/countries/500/fin.png'],
    ['football', '', 'Slovakia', ['slovakia'], 'https://a.espncdn.com/i/teamlogos/countries/500/svk.png'],
    ['football', '', 'Slovenia', ['slovenia'], 'https://a.espncdn.com/i/teamlogos/countries/500/svn.png'],
    ...
    ['football', '', 'Uruguay', ['uruguay'], 'https://a.espncdn.com/i/teamlogos/countries/500/uru.png'],
    ['football', '', 'Chile', ['chile'], 'https://a.espncdn.com/i/teamlogos/countries/500/chi.png'],
    ['football', '', 'Peru', ['peru'], 'https://a.espncdn.com/i/teamlogos/countries/500/per.png'],
    ['football', '', 'Ecuador', ['ecuador'], 'https://a.espncdn.com/i/teamlogos/countries/500/ecu.png'],
    ['football', '', 'Paraguay', ['paraguay'], 'https://a.espncdn.com/i/teamlogos/countries/500/par.png'],
    ['football', '', 'Venezuela', ['venezuela'], 'https://a.espncdn.com/i/teamlogos/countries/500/ven.png'],
    ...
    ['football', '', 'Egypt', ['egypt'], 'https://a.espncdn.com/i/teamlogos/countries/500/egy.png'],
    ['football', '', 'Cameroon', ['cameroon'], 'https://a.espncdn.com/i/teamlogos/countries/500/crm.png'],
    ['football', '', 'Ghana', ['ghana'], 'https://a.espncdn.com/i/teamlogos/countries/500/gha.png'],
    ['football', '', 'Ivory Coast', ['ivory coast', 'cote divoire', 'cÃ´te divoire'], 'https://a.espncdn.com/i/teamlogos/countries/500/civ.png'],
    ...
    ['cricket', '', 'Pakistan', ['pakistan', 'green shirts'], 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/PCB_Logo.svg/960px-PCB_Logo.svg.png'],
    ['cricket', '', 'New Zealand', ['new zealand', 'blackcaps', 'black caps'], 'https://upload.wikimedia.org/wikipedia/en/1/19/Logo_of_cricket_New_zealand_Team.png'],
    ['cricket', '', 'West Indies', ['west indies', 'windies'], 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Cricket_West_Indies_Logo_2017.svg/960px-Cricket_West_Indies_Logo_2017.svg.png'],
    ['cricket', '', 'Afghanistan', ['afghanistan'], 'https://upload.wikimedia.org/wikipedia/commons/1/1f/Afghanistan_cricket_board_logo.jpg'],
    ...
    ['american-football', 'NFL', 'AFC', ['afc', 'pro bowl games afc'], 'https://a.espncdn.com/i/teamlogos/nfl/500/afc.png'],
    ['american-football', 'NFL', 'NFC', ['nfc', 'pro bowl games nfc'], 'https://a.espncdn.com/i/teamlogos/nfl/500/nfc.png'],
    ['american-football', 'NFL', 'Buffalo Bills', ['bills', 'buf'], 'https://a.espncdn.com/i/teamlogos/nfl/500/buf.png'],
    ['american-football', 'NFL', 'Denver Broncos', ['broncos', 'den'], 'https://a.espncdn.com/i/teamlogos/nfl/500/den.png'],
    ['american-football', 'NFL', 'Kansas City Chiefs', ['chiefs', 'kc'], 'https://a.espncdn.com/i/teamlogos/nfl/500/kc.png'],
    ['american-football', 'NFL', 'Los Angeles Rams', ['la rams', 'rams', 'lar'], 'https://a.espncdn.com/i/teamlogos/nfl/500/lar.png'],
    ['american-football', 'NFL', 'New England Patriots', ['patriots', 'new england', 'ne'], 'https://a.espncdn.com/i/teamlogos/nfl/500/ne.png'],
    ['american-football', 'NFL', 'Seattle Seahawks', ['seahawks', 'sea'], 'https://a.espncdn.com/i/teamlogos/nfl/500/sea.png'],
    ['american-football', 'UFL', 'DC Defenders', ['dc defenders', 'defenders'], 'https://r2.thesportsdb.com/images/media/team/badge/53u2201676895966.png'],
    ...
    ['football', '', 'Corinthians', ['corinthians', 'cor'], 'https://a.espncdn.com/i/teamlogos/soccer/500/874.png'],
    ['football', '', 'Cusco FC', ['cusco', 'cusco fc', 'cus'], 'https://a.espncdn.com/i/teamlogos/soccer/500/11995.png'],
    ['football', '', 'Hull City', ['hull city', 'hull', 'hul'], 'https://a.espncdn.com/i/teamlogos/soccer/500/306.png'],
    ['football', '', 'Independiente Medellin', ['independiente medellin', 'independiente medellin fc', 'dim'], 'https://a.espncdn.com/i/teamlogos/soccer/500/2690.png'],
    ['football', '', 'Kilmarnock', ['kilmarnock', 'kil'], 'https://a.espncdn.com/i/teamlogos/soccer/500/260.png'],
    ['football', '', 'Lens', ['rc lens', 'lens', 'rcl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/175.png'],
    ['football', '', 'Livingston', ['livingston', 'liv'], 'https://a.espncdn.com/i/teamlogos/soccer/500/259.png'],
    ['football', '', 'Middlesbrough', ['middlesbrough', 'boro', 'mid'], 'https://a.espncdn.com/i/teamlogos/soccer/500/369.png'],
    ['football', '', 'Nice', ['ogc nice', 'nice'], 'https://a.espncdn.com/i/teamlogos/soccer/500/2502.png'],
    ['football', '', 'Partick Thistle', ['partick thistle', 'partick', 'pt'], 'https://a.espncdn.com/i/teamlogos/soccer/500/247.png'],
    ['football', '', 'Penarol', ['penarol', 'pen'], 'https://a.espncdn.com/i/teamlogos/soccer/500/2683.png'],
    ['football', '', 'St Mirren', ['st mirren', 'st. mirren', 'stm'], 'https://a.espncdn.com/i/teamlogos/soccer/500/250.png'],
    ...
    ['football', '', 'Atlanta United FC', ['atlanta united', 'atl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/18418.png'],
    ['football', '', 'Austin FC', ['atx'], 'https://a.espncdn.com/i/teamlogos/soccer/500/20906.png'],
    ['football', '', 'CF Montreal', ['club de foot montreal', 'cf montreal', 'montreal impact', 'mtl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/9720.png'],
    ['football', '', 'Charlotte FC', ['clt'], 'https://a.espncdn.com/i/teamlogos/soccer/500/21300.png'],
    ['football', '', 'Chicago Fire FC', ['chicago fire', 'cff', 'chi'], 'https://a.espncdn.com/i/teamlogos/soccer/500/182.png'],
    ['football', '', 'Colorado Rapids', ['rapids', 'col'], 'https://a.espncdn.com/i/teamlogos/soccer/500/184.png'],
    ['football', '', 'Columbus Crew', ['crew', 'clb'], 'https://a.espncdn.com/i/teamlogos/soccer/500/183.png'],
    ['football', '', 'D.C. United', ['dc united', 'd c united', 'dc'], 'https://a.espncdn.com/i/teamlogos/soccer/500/193.png'],
    ['football', '', 'FC Cincinnati', ['cincinnati', 'cin'], 'https://a.espncdn.com/i/teamlogos/soccer/500/18267.png'],
    ['football', '', 'FC Dallas', ['dallas', 'dal'], 'https://a.espncdn.com/i/teamlogos/soccer/500/185.png'],
    ['football', '', 'Houston Dynamo FC', ['houston dynamo', 'hou'], 'https://a.espncdn.com/i/teamlogos/soccer/500/6077.png'],
    ['football', '', 'Inter Miami CF', ['inter miami', 'miami', 'mia'], 'https://a.espncdn.com/i/teamlogos/soccer/500/20232.png'],
    ['football', '', 'LA Galaxy', ['los angeles galaxy', 'galaxy'], 'https://a.espncdn.com/i/teamlogos/soccer/500/187.png'],
    ['football', '', 'LAFC', ['los angeles fc', 'lafc'], 'https://a.espncdn.com/i/teamlogos/soccer/500/18966.png'],
    ['football', '', 'Louisville City FC', ['loucity', 'louisville city'], 'https://a.espncdn.com/i/teamlogos/soccer/500/17832.png'],
    ['football', '', 'Minnesota United FC', ['minnesota united', 'min'], 'https://a.espncdn.com/i/teamlogos/soccer/500/17362.png'],
    ['football', '', 'Nashville SC', ['nashville', 'nsh'], 'https://a.espncdn.com/i/teamlogos/soccer/500/18986.png'],
    ['football', '', 'New England Revolution', ['revolution', 'revs', 'ne'], 'https://a.espncdn.com/i/teamlogos/soccer/500/189.png'],
    ['football', '', 'New York City FC', ['nycfc', 'nyc'], 'https://a.espncdn.com/i/teamlogos/soccer/500/17606.png'],
    ['football', '', 'New York Red Bulls', ['red bull new york', 'ny red bulls', 'rbny'], 'https://a.espncdn.com/i/teamlogos/soccer/500/190.png'],
    ['football', '', 'Orlando City SC', ['orlando city', 'orl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/12011.png'],
    ['football', '', 'Philadelphia Union', ['union', 'phi'], 'https://a.espncdn.com/i/teamlogos/soccer/500/10739.png'],
    ['football', '', 'Portland Timbers', ['timbers', 'por'], 'https://a.espncdn.com/i/teamlogos/soccer/500/9723.png'],
    ['football', '', 'Real Salt Lake', ['rsl', 'salt lake', 'slc'], 'https://a.espncdn.com/i/teamlogos/soccer/500/4771.png'],
    ['football', '', 'San Diego FC', ['sdfc', 'sd'], 'https://a.espncdn.com/i/teamlogos/soccer/500/22529.png'],
    ['football', '', 'San Jose Earthquakes', ['earthquakes', 'quakes', 'sj'], 'https://a.espncdn.com/i/teamlogos/soccer/500/191.png'],
    ['football', '', 'Seattle Sounders FC', ['seattle sounders', 'sounders', 'sea'], 'https://a.espncdn.com/i/teamlogos/soccer/500/9726.png'],
    ['football', '', 'Sporting Kansas City', ['sporting kc', 'sporting kansas city', 'skc'], 'https://a.espncdn.com/i/teamlogos/soccer/500/186.png'],
    ['football', '', 'St. Louis CITY SC', ['st louis city sc', 'st. louis city sc', 'st louis city', 'stl'], 'https://a.espncdn.com/i/teamlogos/soccer/500/21812.png'],
    ['football', '', 'Toronto FC', ['toronto', 'tor'], 'https://a.espncdn.com/i/teamlogos/soccer/500/7318.png'],
    ['football', '', 'Vancouver Whitecaps', ['vancouver whitecaps', 'whitecaps', 'van'], 'https://a.espncdn.com/i/teamlogos/soccer/500/9727.png'],
    ...
    ['basketball', 'EasyCredit BBL', 'ALBA Berlin', ['alba berlin', 'alba'], 'https://r2.thesportsdb.com/images/media/team/badge/58osvu1545866407.png'],
    ['basketball', 'EasyCredit BBL', 'Bamberg Baskets', ['bamberg baskets', 'bamberg basket', 'bamberg', 'bma 365 bamberg basket'], 'https://r2.thesportsdb.com/images/media/team/badge/rs1gjz1714562746.png'],
    ['basketball', 'EasyCredit BBL', 'Rasta Vechta', ['rasta vechta', 'vechta'], 'https://r2.thesportsdb.com/images/media/team/badge/ukssyu1714562769.png'],
    ['basketball', 'EasyCredit BBL', 'Ulm', ['ulm', 'ratiopharm ulm'], 'https://r2.thesportsdb.com/images/media/team/badge/0t59iu1677678278.png'],
    ['basketball', 'EuroLeague Basketball', 'Fenerbahce Basketbol', ['fenerbahce', 'fenerbahce basketbol', 'fenerbahce beko'], 'https://r2.thesportsdb.com/images/media/team/badge/u6j0qb1758794065.png'],
    ['basketball', 'EuroLeague Basketball', 'Olympiacos BC', ['olympiacos', 'olympiacos bc'], 'https://r2.thesportsdb.com/images/media/team/badge/4s5lug1676581220.png'],
    ['basketball', 'EuroLeague Basketball', 'Real Madrid Baloncesto', ['real madrid baloncesto', 'real madrid basket', 'real madrid basketball'], 'https://r2.thesportsdb.com/images/media/team/badge/g4ev2c1522175902.png'],
    ['basketball', 'EuroLeague Basketball', 'Valencia Basket', ['valencia basket', 'valencia'], 'https://r2.thesportsdb.com/images/media/team/badge/9qyc231536398868.png'],
    ...
    ['basketball', 'AFL', 'Gold Coast Suns', ['gold coast suns', 'gcs'], AFL_GOLD_COAST_SUNS_LOGO_URL],
    ['basketball', 'AFL', 'North Melbourne', ['north melbourne', 'north melbourne kangaroos', 'kangaroos', 'nm'], AFL_NORTH_MELBOURNE_LOGO_URL],
    ['cricket', 'Indian Premier League', 'Royal Challengers Bangalore', ['royal challengers bangalore', 'royal challengers bengaluru', 'royal challengers', 'rcb'], 'https://r2.thesportsdb.com/images/media/team/badge/kynj5v1588331757.png'],
    ['rugby', 'AFL', 'Gold Coast Suns', ['gold coast suns', 'gcs'], AFL_GOLD_COAST_SUNS_LOGO_URL],
    ['rugby', 'AFL', 'North Melbourne', ['north melbourne', 'north melbourne kangaroos', 'kangaroos', 'nm'], AFL_NORTH_MELBOURNE_LOGO_URL],
    ['australian-football', 'AFL', 'Gold Coast Suns', ['gold coast suns', 'gcs'], AFL_GOLD_COAST_SUNS_LOGO_URL],
    ['australian-football', 'AFL', 'North Melbourne', ['north melbourne', 'north melbourne kangaroos', 'kangaroos', 'nm'], AFL_NORTH_MELBOURNE_LOGO_URL],
    ['australian-rules-football', 'AFL', 'Gold Coast Suns', ['gold coast suns', 'gcs'], AFL_GOLD_COAST_SUNS_LOGO_URL],
    ['australian-rules-football', 'AFL', 'North Melbourne', ['north melbourne', 'north melbourne kangaroos', 'kangaroos', 'nm'], AFL_NORTH_MELBOURNE_LOGO_URL],
    ['australian-football', 'AFL', 'Adelaide Crows', ['adelaide crows', 'crows'], 'https://r2.thesportsdb.com/images/media/team/badge/2nh2z01731592341.png'],
    ['australian-football', 'AFL', 'Brisbane Lions', ['brisbane lions', 'lions'], 'https://r2.thesportsdb.com/images/media/team/badge/tvvxvp1474038810.png'],
    ['australian-football', 'AFL', 'Carlton', ['carlton blues', 'carlton', 'blues'], 'https://r2.thesportsdb.com/images/media/team/badge/k9no791584810309.png'],
    ['australian-football', 'AFL', 'Collingwood', ['collingwood magpies', 'collingwood', 'magpies', 'pies'], 'https://r2.thesportsdb.com/images/media/team/badge/a2uqkd1584810538.png'],
    ['australian-football', 'AFL', 'Essendon', ['essendon bombers', 'essendon', 'bombers'], 'https://r2.thesportsdb.com/images/media/team/badge/xwupps1474039541.png'],
    ['australian-football', 'AFL', 'Fremantle', ['fremantle dockers', 'fremantle', 'dockers', 'freo'], 'https://r2.thesportsdb.com/images/media/team/badge/hw34ii1647870691.png'],
    ['australian-football', 'AFL', 'Geelong', ['geelong cats', 'geelong', 'cats'], 'https://r2.thesportsdb.com/images/media/team/badge/xapo7t1647870681.png'],
    ['australian-football', 'AFL', 'GWS Giants', ['greater western sydney', 'gws giants', 'gws', 'giants'], 'https://r2.thesportsdb.com/images/media/team/badge/ef6rqs1647870839.png'],
    ['australian-football', 'AFL', 'Hawthorn', ['hawthorn hawks', 'hawthorn', 'hawks'], 'https://r2.thesportsdb.com/images/media/team/badge/18y3ks1647870779.png'],
    ['australian-football', 'AFL', 'Melbourne Demons', ['melbourne demons', 'demons', 'dees'], 'https://r2.thesportsdb.com/images/media/team/badge/xvtstv1474039391.png'],
    ['australian-football', 'AFL', 'Port Adelaide', ['port adelaide power', 'port adelaide', 'power'], 'https://r2.thesportsdb.com/images/media/team/badge/7qvqn81584810882.png'],
    ['australian-football', 'AFL', 'Richmond Tigers', ['richmond tigers', 'richmond', 'tigers'], 'https://r2.thesportsdb.com/images/media/team/badge/xkqlvb1647870792.png'],
    ['australian-football', 'AFL', 'St Kilda', ['st kilda saints', 'st kilda', 'saints'], 'https://r2.thesportsdb.com/images/media/team/badge/fvj5ez1732026459.png'],
    ['australian-football', 'AFL', 'Sydney Swans', ['sydney swans', 'swans'], 'https://r2.thesportsdb.com/images/media/team/badge/ndeir91647870648.png'],
    ['australian-football', 'AFL', 'West Coast Eagles', ['west coast eagles', 'west coast', 'eagles'], 'https://r2.thesportsdb.com/images/media/team/badge/xpcp2f1647870746.png'],
    ['australian-football', 'AFL', 'Western Bulldogs', ['western bulldogs', 'bulldogs', 'footscray'], 'https://r2.thesportsdb.com/images/media/team/badge/e3hg551647870757.png'],
    ['rugby', 'European Rugby Challenge Cup', 'Challenge Cup', ['challenge cup', 'epcr challenge cup'], 'https://r2.thesportsdb.com/images/media/league/logo/dwmh511716589311.png'],
    ['rugby', 'European Rugby Challenge Cup', 'Ulster', ['ulster', 'ulster incl', 'ulster rugby'], 'https://r2.thesportsdb.com/images/media/team/badge/j8usvw1716743144.png'],
    ['rugby', 'NRL', 'Canterbury Bankstown Bulldogs', ['canterbury bankstown bulldogs', 'canterbury bulldogs', 'bulldogs', 'bull'], 'https://r2.thesportsdb.com/images/media/team/badge/ggzq4e1768487178.png'],
    ['rugby', 'NRL', 'Melbourne Storm', ['melbourne storm', 'storm', 'sto'], 'https://r2.thesportsdb.com/images/media/team/badge/hpdn401646347751.png'],
    ['rugby', 'NRL', 'Brisbane Broncos', ['brisbane broncos', 'broncos'], 'https://r2.thesportsdb.com/images/media/team/badge/yjgl741768487372.png'],
    ['rugby', 'NRL', 'Canberra Raiders', ['canberra raiders', 'canberra', 'raiders'], 'https://r2.thesportsdb.com/images/media/team/badge/54ebov1768508580.png'],
    ['rugby', 'NRL', 'Cronulla Sharks', ['cronulla sharks', 'cronulla'], 'https://r2.thesportsdb.com/images/media/team/badge/qn3n5r1552073088.png'],
    ['rugby', 'NRL', 'Dolphins', ['redcliffe dolphins', 'the dolphins', 'dolphins'], 'https://r2.thesportsdb.com/images/media/team/badge/tyoy421672068536.png'],
    ['rugby', 'NRL', 'Gold Coast Titans', ['gold coast titans', 'titans'], 'https://r2.thesportsdb.com/images/media/team/badge/4qqmp81646347724.png'],
    ['rugby', 'NRL', 'Manly Sea Eagles', ['manly sea eagles', 'sea eagles', 'manly'], 'https://r2.thesportsdb.com/images/media/team/badge/oke63j1768508683.png'],
    ['rugby', 'NRL', 'New Zealand Warriors', ['new zealand warriors', 'nz warriors'], 'https://r2.thesportsdb.com/images/media/team/badge/w8b9kw1646347767.png'],
    ['rugby', 'NRL', 'Newcastle Knights', ['newcastle knights', 'knights'], 'https://r2.thesportsdb.com/images/media/team/badge/aes2o51646347790.png'],
    ['rugby', 'NRL', 'North Queensland Cowboys', ['north queensland cowboys', 'north queensland', 'cowboys'], 'https://r2.thesportsdb.com/images/media/team/badge/q6xu7c1646347820.png'],
    ['rugby', 'NRL', 'Parramatta Eels', ['parramatta eels', 'parramatta', 'eels'], 'https://r2.thesportsdb.com/images/media/team/badge/5tvma21646347846.png'],
    ['rugby', 'NRL', 'Penrith Panthers', ['penrith panthers', 'penrith', 'panthers'], 'https://r2.thesportsdb.com/images/media/team/badge/zjh0jo1771495164.png'],
    ['rugby', 'NRL', 'South Sydney Rabbitohs', ['south sydney rabbitohs', 'south sydney', 'rabbitohs', 'souths'], 'https://r2.thesportsdb.com/images/media/team/badge/0m4unp1552072677.png'],
    ['rugby', 'NRL', 'St George Illawarra Dragons', ['st george illawarra dragons', 'st george illawarra', 'st george'], 'https://r2.thesportsdb.com/images/media/team/badge/2dcs6y1646347870.png'],
    ['rugby', 'NRL', 'Sydney Roosters', ['sydney roosters', 'roosters'], 'https://r2.thesportsdb.com/images/media/team/badge/by299w1646347883.png'],
    ['rugby', 'NRL', 'Wests Tigers', ['wests tigers', 'wests', 'west tigers'], 'https://r2.thesportsdb.com/images/media/team/badge/cs6i6f1646347894.png']
...
function sportMatchesLogoRule(ruleSport = '', sport = '') {
  ...
  if (rule === value) return true
  if (resolveSportSlug(rule) && resolveSportSlug(rule) === resolveSportSlug(value)) return true
...
function buildDefaultLogoRequests(fallbackInput = {}) {
  ...
  for (const rule of DEFAULT_LEAGUE_LOGO_RULES) {
    ...
    if (
      ruleLeagueSlug &&
      inputLeagueSlug &&
      ruleLeagueSlug !== inputLeagueSlug &&
      !isGenericLeagueSlug(inputLeagueSlug) &&
      !slugContainsToken(inputLeagueSlug, ruleLeagueSlug)
    ) continue
...
function directLogoInputMatches({ ruleSport = '', ruleLeague = '', sport = '', league = '', text = '', pattern = null } = {}) {
  ...
  if (ruleLeagueSlug && leagueSlug) {
    ...
    if (slugContainsToken(leagueSlug, ruleLeagueSlug)) return true
...
function directTeamLogoUrlFor({ sport = '', league = '', team = '' } = {}) {
  ...
  for (const rule of DIRECT_TEAM_LOGO_OVERRIDES) {
    ...
    if (
      ruleLeagueSlug &&
      leagueSlug &&
      !isGenericLeagueSlug(leagueSlug) &&
      ruleLeagueSlug !== leagueSlug &&
      !slugContainsToken(leagueSlug, ruleLeagueSlug) &&
      !slugContainsToken(ruleLeagueSlug, leagueSlug)
    ) continue
    const aliases = [rule.team, ...(rule.aliases || [])].map(leagueSlugFor).filter(Boolean)
    if (
      aliases.includes(teamSlug) ||
      aliases.some((alias) => alias.length >= 4 && slugContainsToken(teamSlug, alias))
    ) return rule.url
  }
  return ''
}
...
function teamLogoSearchTerms({ sport = '', league = '', team = '', text = '' } = {}) {
  ...
  for (const alias of DEFAULT_TEAM_LOGO_ALIASES) {
    ...
    const aliasLeagueSlug = normalizedLeagueSlug(alias.league)
    if (
      aliasLeagueSlug &&
      leagueSlug &&
      !isGenericLeagueSlug(leagueSlug) &&
      aliasLeagueSlug !== leagueSlug &&
      !slugContainsToken(leagueSlug, aliasLeagueSlug) &&
      !slugContainsToken(aliasLeagueSlug, leagueSlug)
    ) continue
...
async function searchSportsMetaTeamBadgeSourceUrl({ sportsmetaBaseUrl = '', sport = '', league = '', team = '', role = '', text = '' } = {}) {
  const base = getPublicSportsMetaBaseUrl(sportsmetaBaseUrl)
  const sportSlug = resolveSportSlug(sport)
  const normalizedInputLeagueSlug = normalizedLeagueSlug(league)
  const leagueSlug = isGenericLeagueSlug(normalizedInputLeagueSlug) ? '' : normalizedInputLeagueSlug
  ...
  for (const term of terms) {
    try {
      ...
      for (const meta of metas) {
        ...
        const leagueMatches = !leagueSlug ||
          parsed.league === leagueSlug ||
          slugContainsToken(parsed.league, leagueSlug) ||
          slugContainsToken(leagueSlug, parsed.league)
        ...
        if (!sourceUrl) continue
        const result = { sourceUrl, canonicalId: id, variant: side, search: term, role }
        if (leagueMatches) return result
        if (!relaxedMatch) relaxedMatch = result
      }
    } catch (_) {}
  }
  return relaxedMatch
...
function standaloneSvgSymbolBuffer(sourceBuf, targetUrl = '') {
  let symbolId = ''
  try {
    symbolId = decodeURIComponent(new URL(targetUrl).hash.replace(/^#/, ''))
  } catch (_) {
    symbolId = ''
  }
  if (!symbolId) return sourceBuf
  const svg = sourceBuf.toString('utf8')
  const symbolRe = /<symbol\b([^>]*)>([\s\S]*?)<\/symbol>/gi
  const idRe = new RegExp(`\\bid=["']${escapeRegExp(symbolId)}["']`, 'i')
  for (const match of svg.matchAll(symbolRe)) {
    const attrs = match[1] || ''
    if (!idRe.test(attrs)) continue
    const viewBox = attrs.match(/\bviewBox=["']([^"']+)["']/i)?.[1] || '0 0 512 512'
    const body = match[2] || ''
    return Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="${escapeXml(viewBox)}">${body}</svg>`)
  }
  return sourceBuf
}
  ...
  if (!pending) {
    pending = (async () => {
      ...
      try {
        ...
        const fetchedBuf = Buffer.from(await response.arrayBuffer())
        const sourceBuf = /^image\/svg\+xml/i.test(value.contentType)
          ? standaloneSvgSymbolBuffer(fetchedBuf, targetUrl)
          : fetchedBuf
...
async function renderTeamBadgeArtworkPng({ canonicalId = '', sportsmetaBaseUrl = '', variant = 'poster', template = 'editorial', requestedHome = '', requestedAway = '', requestedTitle = '' } = {}) {
  ...
  const selectLogoForSlot = (role = '') => {
    if (role === 'home') return homeBadge || (leagueFallbackForCompetitors ? (leagueLogo || eventIdentity || null) : null)
    if (role === 'away') return awayBadge || (leagueFallbackForCompetitors ? (leagueLogo || eventIdentity || null) : null)
