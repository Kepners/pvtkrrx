...
- `06-ticket-stub` is the one included free/default PVTKRRX poster style. The locked runtime contract has seven poster templates; non-ticket-stub styles are not selectable through PVTKRRX configured installs unless a separate entitlement gate is implemented and proven.
