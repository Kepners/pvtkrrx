...
- `06-ticket-stub` is the default PVTKRRX poster style. The locked runtime contract has seven poster templates, and configured PVTKRRX installs should render whichever valid template the user selects.
