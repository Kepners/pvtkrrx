...
async function run() {
  ...
  assert.equal(
    ...
    `https://addon.test/sports-artwork/id/poster/${encodeURIComponent(barcaId)}.png?token=${encodeURIComponent('https://sportsmeta.test/member/sm_paid_poster_token')}&v=20260428-club-logo-v2`,
  ...
  try {
    ...
    assert.equal(
      ...
      `https://addon.test/sports-artwork/id/poster/${encodeURIComponent(barcaId)}.png?v=20260428-club-logo-v2`,
