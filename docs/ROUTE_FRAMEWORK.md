...
- **Hybrid Home**: After 307 redirect, behaves like PC Local. When the redirect is not available, it falls back to hosted/cloud behavior and can adopt the linked cloud profile for that Stremio account.
